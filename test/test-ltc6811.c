...
void setUp(void) {
    ltc681x_chain_init(&chain, LTC_COUNT);
...
void check_wrcfg_encode_broadcast_length() {
    ...
    size_t byte_count = ltc681x_wrcfg_encode_broadcast(
        &chain,
        config,
        out
    );
...
void check_wrcfg_encode_broadcast_cmd_bytes() {
    ...
    uint8_t out[LTC6811_WRITE_BUFFER_SIZE(LTC_COUNT)];
    ltc681x_wrcfg_encode_broadcast(
        &chain,
        config,
        out
    );
...
void check_rdcfg_encode_broadcast_length() {
    ...
    size_t byte_count = ltc681x_rdcfg_encode_broadcast(
        &chain,
        out
    );
...
void check_rdcfg_encode_broadcast_cmd_bytes() {
    ...
    uint8_t out[LTC6811_READ_BUFFER_SIZE(LTC_COUNT)];
    ltc681x_rdcfg_encode_broadcast(
        &chain,
        out
    );
    TEST_ASSERT_EQUAL_HEX8_ARRAY(cmd, out, LTC6811_CMD_BYTE_COUNT);
...
void check_rdcfg_decode_broadcast_length() {
    ...
    size_t byte_count = ltc681x_rdcfg_decode_broadcast(
        &chain,
        data,
        decoded
    );
...
void check_rdcfg_decode_broadcast_data() {
    ...
    Ltc6811Cfgr decoded[LTC_COUNT] = { 0 };
    ltc681x_rdcfg_decode_broadcast(
        &chain,
        data,
        decoded
    );
...
void check_rdcv_encode_broadcast_length() {
    uint8_t out[LTC6811_READ_BUFFER_SIZE(LTC_COUNT)];
    size_t byte_count = ltc681x_rdcv_encode_broadcast(
        &chain,
        LTC6811_CVAR,
        out
    );
...
void check_rdcv_decode_broadcast_length() {
    ...
    size_t byte_count = ltc681x_rdcv_decode_broadcast(
        &chain,
        data,
        decoded
    );
...
void check_rdaux_encode_broadcast_length() {
    uint8_t out[LTC6811_READ_BUFFER_SIZE(LTC_COUNT)];
    size_t byte_count = ltc681x_rdaux_encode_broadcast(
        &chain,
        LTC6811_AVAR,
        out
    );
...
void check_rdaux_encode_broadcast_cmd_bytes() {
    ...
    uint8_t out[LTC6811_READ_BUFFER_SIZE(LTC_COUNT)];
    ltc681x_rdaux_encode_broadcast(
        &chain,
        LTC6811_AVAR,
        out
    );
...
void check_rdaux_decode_broadcast_length() {
    ...
    uint16_t decoded[LTC_COUNT * LTC6811_REG_CELL_COUNT] = { 0 };
    size_t byte_count = ltc681x_rdaux_decode_broadcast(
        &chain,
        data,
        decoded
    );
...
void check_rdaux_decode_broadcast_data() {
    ...
    uint16_t decoded[LTC_COUNT * LTC6811_REG_CELL_COUNT] = { 0 };
    ltc681x_rdaux_decode_broadcast(
        &chain,
        data,
        decoded
    );
...
void check_rdstat_encode_broadcast_length() {
    uint8_t out[LTC6811_READ_BUFFER_SIZE(LTC_COUNT)];
    size_t byte_count = ltc681x_rdstat_encode_broadcast(
        &chain,
        LTC6811_STAR,
        out
    );
...
void check_rdstat_encode_broadcast_cmd_bytes() {
    ...
    uint8_t out[LTC6811_READ_BUFFER_SIZE(LTC_COUNT)];
    ltc681x_rdstat_encode_broadcast(
        &chain,
        LTC6811_STAR,
        out
    );
...
void check_rdstat_decode_broadcast_length() {
    ...
    size_t byte_count = ltc681x_rdstat_decode_broadcast(
        &chain,
        LTC6811_STAR,
        data,
        decoded
...
void check_rdstat_decode_broadcast_data() {
    ...
    Ltc6811Str decoded[LTC_COUNT] = { 0 };
    ltc681x_rdstat_decode_broadcast(
        &chain,
        LTC6811_STAR,
        data_star,
        decoded
...
void check_wrsctrl_encode_broadcast_length() {
    uint8_t out[LTC6811_WRITE_BUFFER_SIZE(LTC_COUNT)];
    size_t byte_count = ltc681x_wrsctrl_encode_broadcast(
        &chain,
        sctrl,
        out
    );
...
void check_wrsctrl_encode_broadcast_cmd_bytes() {
    ...
    uint8_t out[LTC6811_WRITE_BUFFER_SIZE(LTC_COUNT)];
    ltc681x_wrsctrl_encode_broadcast(
        &chain,
        sctrl,
        out
    );
...
void check_rdsctrl_encode_broadcast_length() {
    uint8_t out[LTC6811_READ_BUFFER_SIZE(LTC_COUNT)];
    size_t byte_count = ltc681x_rdsctrl_encode_broadcast(
        &chain,
        out
    );
    TEST_ASSERT_EQUAL_size_t(LTC6811_READ_BUFFER_SIZE(LTC_COUNT), byte_count);
...
void check_rdsctrl_encode_broadcast_cmd_bytes() {
    ...
    uint8_t out[LTC6811_READ_BUFFER_SIZE(LTC_COUNT)];
    ltc681x_rdsctrl_encode_broadcast(
        &chain,
        out
    );
    TEST_ASSERT_EQUAL_HEX8_ARRAY(cmd, out, LTC6811_CMD_BYTE_COUNT);
...
void check_rdsctrl_decode_broadcast_length() {
    ...
    size_t byte_count = ltc681x_rdsctrl_decode_broadcast(
        &chain,
        data,
        decoded
    );
...
void check_rdsctrl_decode_broadcast_data() {
    ...
    uint8_t decoded[LTC_COUNT * LTC6811_SCTL_COUNT] = { 0 };
    ltc681x_rdsctrl_decode_broadcast(
        &chain,
        data,
        decoded
    );
...
void check_stsctrl_encode_broadcast_length() {
    ...
    size_t byte_count = ltc681x_stsctrl_encode_broadcast(
        &chain,
        out
    );
...
void check_stsctrl_encode_broadcast_cmd_bytes() {
    ...
    uint8_t out[LTC6811_POLL_BUFFER_SIZE(LTC_COUNT)];
    ltc681x_stsctrl_encode_broadcast(
        &chain,
        out
    );
    TEST_ASSERT_EQUAL_HEX8_ARRAY(cmd, out, LTC6811_CMD_BYTE_COUNT);
...
void check_clrsctrl_encode_broadcast_length() {
    uint8_t out[LTC6811_POLL_BUFFER_SIZE(LTC_COUNT)];
    size_t byte_count = ltc681x_clrsctrl_encode_broadcast(
        &chain,
        out
    );
    TEST_ASSERT_EQUAL_size_t(LTC6811_POLL_BUFFER_SIZE(LTC_COUNT), byte_count);
...
void check_clrsctrl_encode_broadcast_cmd_bytes() {
    ...
    uint8_t out[LTC6811_POLL_BUFFER_SIZE(LTC_COUNT)];
    ltc681x_clrsctrl_encode_broadcast(
        &chain,
        out
    );
    TEST_ASSERT_EQUAL_HEX8_ARRAY(cmd, out, LTC6811_CMD_BYTE_COUNT);
...
void check_wrpwm_encode_broadcast_length() {
    uint8_t out[LTC6811_WRITE_BUFFER_SIZE(LTC_COUNT)];
    size_t byte_count = ltc681x_wrpwm_encode_broadcast(
        &chain,
        sctrl,
        out
    );
...
void check_wrpwm_encode_broadcast_cmd_bytes() {
    ...
    uint8_t out[LTC6811_WRITE_BUFFER_SIZE(LTC_COUNT)];
    ltc681x_wrpwm_encode_broadcast(
        &chain,
        sctrl,
        out
    );
...
void check_rdpwm_encode_broadcast_length() {
    uint8_t out[LTC6811_READ_BUFFER_SIZE(LTC_COUNT)];
    size_t byte_count = ltc681x_rdpwm_encode_broadcast(
        &chain,
        out
    );
    TEST_ASSERT_EQUAL_size_t(LTC6811_READ_BUFFER_SIZE(LTC_COUNT), byte_count);
...
void check_rdpwm_encode_broadcast_cmd_bytes() {
    ...
    uint8_t out[LTC6811_READ_BUFFER_SIZE(LTC_COUNT)];
    ltc681x_rdpwm_encode_broadcast(
        &chain,
        out
    );
    TEST_ASSERT_EQUAL_HEX8_ARRAY(cmd, out, LTC6811_CMD_BYTE_COUNT);
...
void check_rdpwm_decode_broadcast_length() {
    ...
    size_t byte_count = ltc681x_rdpwm_decode_broadcast(
        &chain,
        data,
        decoded
    );
...
void check_rdpwm_decode_broadcast_data() {
    ...
    uint8_t decoded[LTC_COUNT * LTC6811_PWM_COUNT] = { 0 };
    ltc681x_rdpwm_decode_broadcast(
        &chain,
        data,
        decoded
    );
...
void check_adcv_encode_broadcast_length() {
    uint8_t out[LTC6811_POLL_BUFFER_SIZE(LTC_COUNT)];
    size_t byte_count = ltc681x_adcv_encode_broadcast(
        &chain,
...
void check_adow_encode_broadcast_length() {
    uint8_t out[LTC6811_POLL_BUFFER_SIZE(LTC_COUNT)];
    size_t byte_count = ltc681x_adow_encode_broadcast(
        &chain,
        LTC6811_MD_26HZ_2KHZ,
        LTC6811_PUP_ACTIVE,
        LTC6811_DCP_ENABLED,
...
void check_cvst_encode_broadcast_length() {
    uint8_t out[LTC6811_POLL_BUFFER_SIZE(LTC_COUNT)];
    size_t byte_count = ltc681x_cvst_encode_broadcast(
        &chain,
        LTC6811_MD_26HZ_2KHZ,
        LTC6811_ST_TWO,
        out
...
void check_adol_encode_broadcast_length() {
    uint8_t out[LTC6811_POLL_BUFFER_SIZE(LTC_COUNT)];
    size_t byte_count = ltc681x_adol_encode_broadcast(
        &chain,
        LTC6811_MD_26HZ_2KHZ,
        LTC6811_DCP_ENABLED,
        out
...
void check_adax_encode_broadcast_length() {
    uint8_t out[LTC6811_POLL_BUFFER_SIZE(LTC_COUNT)];
    size_t byte_count = ltc681x_adax_encode_broadcast(
        &chain,
        LTC6811_MD_26HZ_2KHZ,
...
void check_adaxd_encode_broadcast_length() {
    uint8_t out[LTC6811_POLL_BUFFER_SIZE(LTC_COUNT)];
    size_t byte_count = ltc681x_adaxd_encode_broadcast(
        &chain,
        LTC6811_MD_26HZ_2KHZ,
        LTC6811_CHG_SECOND_REF,
        out
...
void check_adaxd_encode_broadcast_cmd_bytes() {
    ...
    uint8_t cmd[] = { command >> 8, command & 0xFF };
    uint8_t out[LTC6811_POLL_BUFFER_SIZE(LTC_COUNT)];
    ltc681x_adaxd_encode_broadcast(
        &chain,
        LTC6811_MD_26HZ_2KHZ,
        LTC6811_CHG_SECOND_REF,
        out
...
void check_axst_encode_broadcast_length() {
    uint8_t out[LTC6811_POLL_BUFFER_SIZE(LTC_COUNT)];
    size_t byte_count = ltc681x_axst_encode_broadcast(
        &chain,
        LTC6811_MD_26HZ_2KHZ,
        LTC6811_ST_TWO,
        out
...
void check_adstat_encode_broadcast_length() {
    uint8_t out[LTC6811_POLL_BUFFER_SIZE(LTC_COUNT)];
    size_t byte_count = ltc681x_adstat_encode_broadcast(
        &chain,
        LTC6811_MD_26HZ_2KHZ,
        LTC6811_CHST_VD,
        out
...
void check_adstat_encode_broadcast_cmd_bytes() {
    ...
    uint8_t cmd[] = { command >> 8, command & 0xFF };
    uint8_t out[LTC6811_POLL_BUFFER_SIZE(LTC_COUNT)];
    ltc681x_adstat_encode_broadcast(
        &chain,
        LTC6811_MD_26HZ_2KHZ,
        LTC6811_CHST_VD,
        out
...
void check_adstatd_encode_broadcast_length() {
    uint8_t out[LTC6811_POLL_BUFFER_SIZE(LTC_COUNT)];
    size_t byte_count = ltc681x_adstatd_encode_broadcast(
        &chain,
        LTC6811_MD_26HZ_2KHZ,
        LTC6811_CHST_VD,
        out
...
void check_adstatd_encode_broadcast_cmd_bytes() {
    ...
    uint8_t cmd[] = { command >> 8, command & 0xFF };
    uint8_t out[LTC6811_POLL_BUFFER_SIZE(LTC_COUNT)];
    ltc681x_adstatd_encode_broadcast(
        &chain,
        LTC6811_MD_26HZ_2KHZ,
        LTC6811_CHST_VD,
        out
...
void check_statst_encode_broadcast_length() {
    uint8_t out[LTC6811_POLL_BUFFER_SIZE(LTC_COUNT)];
    size_t byte_count = ltc681x_statst_encode_broadcast(
        &chain,
        LTC6811_MD_26HZ_2KHZ,
        LTC6811_ST_TWO,
        out
...
void check_statst_encode_broadcast_cmd_bytes() {
    ...
    uint8_t cmd[] = { command >> 8, command & 0xFF };
    uint8_t out[LTC6811_POLL_BUFFER_SIZE(LTC_COUNT)];
    ltc681x_statst_encode_broadcast(
        &chain,
        LTC6811_MD_26HZ_2KHZ,
        LTC6811_ST_TWO,
        out
...
void check_adcvax_encode_broadcast_length() {
    uint8_t out[LTC6811_POLL_BUFFER_SIZE(LTC_COUNT)];
    size_t byte_count = ltc681x_adcvax_encode_broadcast(
        &chain,
        LTC6811_MD_26HZ_2KHZ,
        LTC6811_DCP_ENABLED,
        out
...
void check_adcvax_encode_broadcast_cmd_bytes() {
    ...
    uint8_t cmd[] = { command >> 8, command & 0xFF };
    uint8_t out[LTC6811_POLL_BUFFER_SIZE(LTC_COUNT)];
    ltc681x_adcvax_encode_broadcast(
        &chain,
        LTC6811_MD_26HZ_2KHZ,
        LTC6811_DCP_ENABLED,
        out
...
void check_adcvsc_encode_broadcast_length() {
    uint8_t out[LTC6811_POLL_BUFFER_SIZE(LTC_COUNT)];
    size_t byte_count = ltc681x_adcvsc_encode_broadcast(
        &chain,
        LTC6811_MD_26HZ_2KHZ,
        LTC6811_DCP_ENABLED,
        out
...
void check_adcvsc_encode_broadcast_cmd_bytes() {
    ...
    uint8_t cmd[] = { command >> 8, command & 0xFF };
    uint8_t out[LTC6811_POLL_BUFFER_SIZE(LTC_COUNT)];
    ltc681x_adcvsc_encode_broadcast(
        &chain,
        LTC6811_MD_26HZ_2KHZ,
        LTC6811_DCP_ENABLED,
        out
...
void check_clrcell_encode_broadcast_length() {
    uint8_t out[LTC6811_POLL_BUFFER_SIZE(LTC_COUNT)];
    size_t byte_count = ltc681x_clrcell_encode_broadcast(
        &chain,
        out
    );
    TEST_ASSERT_EQUAL_size_t(LTC6811_POLL_BUFFER_SIZE(LTC_COUNT), byte_count);
...
void check_clrcell_encode_broadcast_cmd_bytes() {
    ...
    uint8_t out[LTC6811_POLL_BUFFER_SIZE(LTC_COUNT)];
    ltc681x_clrcell_encode_broadcast(
        &chain,
        out
    );
    TEST_ASSERT_EQUAL_HEX8_ARRAY(cmd, out, LTC6811_CMD_BYTE_COUNT);
...
void check_clraux_encode_broadcast_length() {
    uint8_t out[LTC6811_POLL_BUFFER_SIZE(LTC_COUNT)];
    size_t byte_count = ltc681x_clraux_encode_broadcast(
        &chain,
        out
    );
    TEST_ASSERT_EQUAL_size_t(LTC6811_POLL_BUFFER_SIZE(LTC_COUNT), byte_count);
...
void check_clraux_encode_broadcast_cmd_bytes() {
    ...
    uint8_t out[LTC6811_POLL_BUFFER_SIZE(LTC_COUNT)];
    ltc681x_clraux_encode_broadcast(
        &chain,
        out
    );
    TEST_ASSERT_EQUAL_HEX8_ARRAY(cmd, out, LTC6811_CMD_BYTE_COUNT);
...
void check_clrstat_encode_broadcast_length() {
    uint8_t out[LTC6811_POLL_BUFFER_SIZE(LTC_COUNT)];
    size_t byte_count = ltc681x_clrstat_encode_broadcast(
        &chain,
        out
    );
    TEST_ASSERT_EQUAL_size_t(LTC6811_POLL_BUFFER_SIZE(LTC_COUNT), byte_count);
...
void check_clrstat_encode_broadcast_cmd_bytes() {
    ...
    uint8_t out[LTC6811_POLL_BUFFER_SIZE(LTC_COUNT)];
    ltc681x_clrstat_encode_broadcast(
        &chain,
        out
    );
    TEST_ASSERT_EQUAL_HEX8_ARRAY(cmd, out, LTC6811_CMD_BYTE_COUNT);
...
void check_pladc_encode_broadcast_length() {
    uint8_t out[LTC6811_POLL_BUFFER_SIZE(LTC_COUNT)];
    size_t byte_count = ltc681x_pladc_encode_broadcast(
        &chain,
        out
    );
    TEST_ASSERT_EQUAL_size_t(LTC6811_POLL_BUFFER_SIZE(LTC_COUNT), byte_count);
...
void check_pladc_encode_broadcast_cmd_bytes() {
    ...
    uint8_t out[LTC6811_POLL_BUFFER_SIZE(LTC_COUNT)];
    ltc681x_pladc_encode_broadcast(
        &chain,
        out
    );
    TEST_ASSERT_EQUAL_HEX8_ARRAY(cmd, out, LTC6811_CMD_BYTE_COUNT);
...
void check_pladc_check_conversion_running() {
    TEST_ASSERT_FALSE(ltc681x_pladc_check(0x07));
}
void check_pladc_check_conversion_ended() {
    TEST_ASSERT_TRUE(ltc681x_pladc_check(0xFF));
}

void check_diagn_encode_broadcast_length() {
    uint8_t out[LTC6811_POLL_BUFFER_SIZE(LTC_COUNT)];
    size_t byte_count = ltc681x_diagn_encode_broadcast(
        &chain,
        out
    );
    TEST_ASSERT_EQUAL_size_t(LTC6811_POLL_BUFFER_SIZE(LTC_COUNT), byte_count);
...
void check_diagn_encode_broadcast_cmd_bytes() {
    ...
    uint8_t out[LTC6811_POLL_BUFFER_SIZE(LTC_COUNT)];
    ltc681x_diagn_encode_broadcast(
        &chain,
        out
    );
    TEST_ASSERT_EQUAL_HEX8_ARRAY(cmd, out, LTC6811_CMD_BYTE_COUNT);
...
void check_wrcomm_encode_broadcast_length() {
    uint8_t out[LTC6811_WRITE_BUFFER_SIZE(LTC_COUNT)];
    size_t byte_count = ltc681x_wrcomm_encode_broadcast(
        &chain,
        comm,
        out
    );
...
void check_wrcomm_encode_broadcast_cmd_bytes() {
    ...
    uint8_t out[LTC6811_WRITE_BUFFER_SIZE(LTC_COUNT)];
    ltc681x_wrcomm_encode_broadcast(
        &chain,
        comm,
        out
    );
...
void check_rdcomm_encode_broadcast_length() {
    uint8_t out[LTC6811_READ_BUFFER_SIZE(LTC_COUNT)];
    size_t byte_count = ltc681x_rdcomm_encode_broadcast(
        &chain,
        out
    );
    TEST_ASSERT_EQUAL_size_t(LTC6811_READ_BUFFER_SIZE(LTC_COUNT), byte_count);
...
void check_rdcomm_encode_broadcast_cmd_bytes() {
    ...
    uint8_t out[LTC6811_READ_BUFFER_SIZE(LTC_COUNT)];
    ltc681x_rdcomm_encode_broadcast(
        &chain,
        out
    );
    TEST_ASSERT_EQUAL_HEX8_ARRAY(cmd, out, LTC6811_CMD_BYTE_COUNT);
...
void check_rdcomm_decode_broadcast_length() {
    ...
    size_t byte_count = ltc681x_rdcomm_decode_broadcast(
        &chain,
        data,
        decoded
    );
...
void check_rdcomm_decode_broadcast_data() {
    ...
    Ltc6811Comm decoded[LTC_COUNT] = { 0 };
    ltc681x_rdcomm_decode_broadcast(
        &chain,
        data,
        decoded
    );
...
void check_stcomm_encode_broadcast_length() {
    ...
    size_t byte_count = ltc681x_stcomm_encode_broadcast(
        &chain,
        out
    );
...
void check_stcomm_encode_broadcast_cmd_bytes() {
    ...
    uint8_t out[LTC6811_STCOMM_BUFFER_SIZE(LTC_COUNT)];
    ltc681x_stcomm_encode_broadcast(
        &chain,
        out
    );
    TEST_ASSERT_EQUAL_HEX8_ARRAY(cmd, out, LTC6811_CMD_BYTE_COUNT);
