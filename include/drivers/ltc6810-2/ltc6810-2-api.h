...
/*!
 * \brief           Encode the broadcast redundant S voltage read command
 *
 * \warning         The out array should be large enough to contain all the
 *                  encode bytes.
 *                  Use the LTC6810_2_READ_BUFFER_SIZE macro to get the
 ...
 * \returns         size_t The number of encoded bytes, should be equal to LTC6810_2_POLL_BUFFER_SIZE
 */
size_t ltc6810_2_api_adstat_encode_broadcast(const struct Ltc68102Handler *handler, enum Ltc68102Md mode, enum Ltc68102Chst group, uint8_t *out);
